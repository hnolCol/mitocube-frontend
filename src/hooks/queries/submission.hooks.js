...
export const useGetSubmissionAttributesByTag = (APIParams = {}, useQueryOptions = {}) => {
...
async function getSubmissionStates_API({ tokenString, submission }) {
...
export const useGetSubmissionStates = (APIParams = {}, useQueryOptions = {}) => {
