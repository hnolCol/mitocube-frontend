...
export function QuantificationDistribution({ submission_tag, quantification_type = "protein_groups", width = 25, height = 200, margins = { left: 20, right: 5, bottom: 5, top: 15} }) {
    ...
    return <div className="flex flex-column" style={{gap : "0.2rem"}}>
        ...
        {_.isArray(data) && <viz.charts.minimal.MinimalBoxplots qs={data.map(di => di[1])} margins={margins} boxWidth={20} spaceBetween={5} yaxisLabel="log2 LFQ intensity" width={25 * data.length + 100} height={height} showMedian={false} indicateN={false} verticalLineAtZero={false} />}
    </div>
}
