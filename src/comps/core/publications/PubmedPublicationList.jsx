    ...
    return (<div>
        {isSuccess ? publications.result.uids.map(pubmedid => <motion.div
                    ...
                    className="flex padding--medium div--round bg--white margin--little" whileHover={{ backgroundColor: "#466688", color: "#ffffff" }}>
                        ...
                        <div className="intent-margin-left--little" style={{ fontStyle: "italic" }}>{publications.result[pubmedid].title} <strong>{publications.result[pubmedid].fulljournalname}</strong></div>
                        <div className="intent-margin-left--little">({publications.result[pubmedid].pubdate})</div>
