                ...
                const chunk = chunkLines
                    ...
                    .map((line) => {
                        ...
                        return {
                            ...
                            score: cols[columnIndex.score],
                            tag : cols[columnIndex.peptide_tag], //the peptide tag equals the stripped sequence
                            rt: cols[columnIndex.rt],
                            charge: cols[columnIndex.charge],
