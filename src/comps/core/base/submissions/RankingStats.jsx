...
export function RankingStats({ attribute_tag, submission_tag, stats }) { 
    ...
    const { data : condition_applications} = hooks.submissions.condition_applications.useGetSubmissionSampleConditionApplications({tag : submission_tag, attribute_tags :attribute_tag, return_unique : true}, {enabled : _.isString(submission_tag) && _.isString(attribute_tag) }    )
