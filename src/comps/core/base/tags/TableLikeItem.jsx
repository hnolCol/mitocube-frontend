...
import { areAllValuesArrays } from "../../../../services/arrays/checks";
...
export function ListAsTags(props) {
    const {array} = props
    return (
...
export function TableLikeItem(props) {
