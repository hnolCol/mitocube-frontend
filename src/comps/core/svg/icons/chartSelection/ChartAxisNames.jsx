...
export function XAxisName({ height = 25,width = 25, placeholder = "", items = [{ text: "Menu1" }], selectedItems = [], callbackKey = undefined, callback = undefined,callbackValueOnly = false, margin = 7, minimal = false, itemIsAttribute = true}) {
    const iconHeight = height-margin
    return (
        <ComboboxIconBase {...{height,width,placeholder,items,callback,callbackKey,callbackValueOnly,selectedItems,minimal, itemIsAttribute}}>
 ...
 * @returns 
 */
export function YAxisName({ height = 25, width = 25, placeholder = "", items = [{ text: "Menu1" }], selectedItems = [], callbackKey = undefined, callback = undefined,callbackValueOnly = false, margin = 7, minimal = false, itemIsAttribute = true }) {
    const iconHeight = height - margin
