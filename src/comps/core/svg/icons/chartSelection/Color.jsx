...
function ColorIconWithName({ height = 25, width = 25, placeholder = "", items = [{ text: "Menu1" }], selectedItems = [], callbackKey = undefined, callback = undefined,callbackValueOnly = false, minimal = true, itemIsAttribute = true    }) {
    const circleRadius = 5
    const colorPalette = getColorPalette(3)
    return (
        <ComboboxIconBase {...{height,placeholder,items,callback,callbackKey,callbackValueOnly,selectedItems, minimal, itemIsAttribute}}>
            {[
