...
export function OpenAiPublicationSummary({ feature_tag }) {
    ...
    const { data: summary, isLoading, isError, error } = hooks.openai.useGetPublicationSummaryForProtein({ tag: feature_tag, limit : selectedLimit, sort_by: selectedSortBy }, { enabled: !!feature_tag && _.isString(feature_tag) });
    ...
    return (
        <div>
            ...
            <OpenAIWarning />
            <div className="padding--medium bg--lightgrey" style={{marginTop: "1rem", borderRadius: "5px" }}>
