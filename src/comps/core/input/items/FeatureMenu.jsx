...
export function FeatureMenuItem({ feature, onClick, active = false, selected = false }) {
    ...
    return (
        ...
        <button className={`menu_item ${selected?"menu_item__selected":""} ${active?"menu_item__active":""} `} onClick={(e) => onClick(feature,e)}>
                <div className="flex justify-space-between">
                    <div className="menu_item_text">{feature.gene_name}</div>
