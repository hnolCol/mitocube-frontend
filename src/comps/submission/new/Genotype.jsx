...
function AttributeSelection({genotypeLabel, attribute, attributeValues, onSelection, selectedAttributeValue = undefined, entryIdx }) {
    ...
    popoverTargetProps = {{backgroundColor:"red"}}
        ...
        onItemSelect={attributeValue => onSelection(genotypeLabel, attribute.tag, attributeValue, entryIdx)}
        resetOnSelect={true}
    >
...
function PositionSelection({authenticationStatus, featureID}) {
   ...
   // console.log(feautreAnnotations)
    ...
    const handleMouseEnter = (aaPosition) => {
                        ...
                        return <div key={`${splitSeq}-${idx}`} className="bg--white" style={{ margin: "0.4rem" }}>
                            ...
                            <div className="flex" style={{ cursor: "crosshair" }}>{splitSeq.split("").map((aa, aaIdx) =>{
                                ...
                                return <motion.span key={`${aminoAcidPosition}-${aa}`} className="intent-padding-bottom--smallest"
                                    ...
                                    onMouseEnter={() => handleMouseEnter(aminoAcidPosition)}
