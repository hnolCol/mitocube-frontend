                ...
                <div className="flex margin--little padding--little bg--grey">
                    ...
                    <div className="flex padding--little">
                        ...
                        <div className="flex">
                            ...
                            <div><IncreaseButton onReduce={() => handleChange(true, false)} /></div>
                        </div>
...
export function MaintenanceSpareParts({ maintenance_event, refetch }) {
    ...
    return <div className="flex">
        <div className="flex-column"><div>Spare Parts used</div>
            <div className="flex">
                {_.isArray(maintenance_event.sparepart_tags) && maintenance_event.sparepart_tags.length > 0 ?
                    maintenance_event.sparepart_tags.map((sparepart_tag, idx) =>
                        <MaintenanceSparePart key={`${idx}-${sparepart_tag}`} tag={sparepart_tag} onSparePartChange={handleSparePartSelect} maintenance_event_tag = {maintenance_event_tag } />)
                    : null}
            </div>
        </div>
